...
const QUERIES = [
  ...
  [7311, "/fx", { base: "usd", target: "eur" }, "usd to eur fx"],
  [7311, "/fx", { base: "usd", target: "ngn" }, "usd to ngn fx"],
  [7311, "/financials", { symbols: "sol,eth", vs_currencies: "usd" }, "sol,eth financials"],
