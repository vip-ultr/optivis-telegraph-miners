# eth-rlp documentation build configuration file, created by
...
__version__ = package_version("eth-rlp")
...
intersphinx_mapping = {
    ...
    "rlp": ("http://pyrlp.readthedocs.io/en/latest/", None),
