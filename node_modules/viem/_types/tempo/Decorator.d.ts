...
type DecoratorBase<chain extends Chain | undefined = Chain | undefined, account extends Account | undefined = Account | undefined> = {
    ...
    earn: {
        ...
        bindEngine: (parameters: earnActions.bindEngine.Parameters<chain, account>) => Promise<earnActions.bindEngine.ReturnValue>;
        /** Binds an engine and waits for confirmation. */
        bindEngineSync: (parameters: earnActions.bindEngineSync.Parameters<chain, account>) => Promise<earnActions.bindEngineSync.ReturnValue>;
    ...
    zone: {
         ...
         */
        getPortalInfo: (parameters: zoneActions.getPortalInfo.Parameters) => Promise<zoneActions.getPortalInfo.ReturnValue>;
        /**
